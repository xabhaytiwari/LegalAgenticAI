...
Clone the Repository git clone https://github.com/xabhaytiwari/legalagenticai.git 
...
Start the API Server: python main.py The server will start at http://127.0.0.1:3000. (May change, upto you)

Test with cURL: 
curl -X POST "http://127.0.0.1:3000/chat" -H "Content-Type: application/json" -d '{"message": "I want to file a theft complaint", "role": "Complainer"}'
